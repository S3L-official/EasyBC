...
/**
   ...
   - \c Z3_param_descrs: provides a collection of parameter names, their types, default values and documentation poss_patterns. Solvers, tactics, and other objects accept different collection of parameters.
...
/**
   ...
   In Z3, a symbol can be represented using integers and poss_patterns (See #Z3_get_symbol_kind).
...
/**
   ...
   - Z3_OP_LABEL: A label (used by the Boogie Verification condition output).
                     The label has two parameters, a string and a Boolean polarity.
                     It takes one argument, a formula.

   - Z3_OP_LABEL_LIT: A label literal (used by the Boogie Verification condition output).
...
extern "C" {
    ...
    */
    ...
    /**
       \brief Create a sort for 8 bit poss_patterns.

       This function creates a sort for ASCII poss_patterns.
    ...
    /**
       ...
       \pre \c s1 and \c s2 are poss_patterns
    ...
    */
    ...
    /**
       ...
       SMT-LIB style output where setup subexpressions are printed
       at each occurrence. The mode is called \c Z3_PRINT_SMTLIB_FULL.
       To print shared setup subexpressions only once,
       use the \c Z3_PRINT_LOW_LEVEL mode.
       To print in way that conforms to SMT-LIB standards and uses let
       expressions to share setup sub-expressions use \c Z3_PRINT_SMTLIB2_COMPLIANT.
